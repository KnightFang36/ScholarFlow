...
// Themed for a pitch-black, monochrome-shiny UI: rainbow mode is off by
// default and the fluid tint is a soft white so the cursor trail reads as
// a "liquid light" smear instead of a colorful splash.
export default function SplashCursor({
  ...
  useEffect(() => {
    ...
    function getWebGLContext(canvas: HTMLCanvasElement) {
      ...
      if (isWebGL2) {
        formatRGBA = getSupportedFormat(glCtx, (glCtx as any).RGBA16F, glCtx.RGBA, halfFloatTexType)
        formatRG = getSupportedFormat(glCtx, (glCtx as any).RG16F, (glCtx as any).RG, halfFloatTexType)
        formatR = getSupportedFormat(glCtx, (glCtx as any).R16F, (glCtx as any).RED, halfFloatTexType)
      } else {
